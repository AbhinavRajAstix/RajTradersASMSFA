...
public class StoreWiseFragmentTwoTab<Context> extends Fragment
{
            ...
            Bundle savedInstanceState) 
    {
      ...
      int check=dbengine.fnCountToDisplayDailySummaryDetailsStoreWiseLines(1,flgReportFromTmpOrPermanent,PersonNodeID,PersonNodeType);
      //dbengine.close();
		...
		{
			////dbengine.open();
			hmapAll_details=dbengine.fnGetDailySummaryDetailsStoreWise(1,flgReportFromTmpOrPermanent,PersonNodeID,PersonNodeType);
			////dbengine.close();
            intializeFields();
		}

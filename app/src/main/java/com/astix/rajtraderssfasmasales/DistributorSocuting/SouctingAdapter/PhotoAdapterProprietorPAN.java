...
public class PhotoAdapterProprietorPAN extends RecyclerView.Adapter<PhotoAdapterProprietorPAN.PhotoViewHolder> {
    ...
    @NonNull
    @Override
    public PhotoAdapterProprietorPAN.PhotoViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull PhotoAdapterProprietorPAN.PhotoViewHolder holder, int position) {

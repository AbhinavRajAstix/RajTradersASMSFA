...
public class PhotoAdapterPANPatner1 extends RecyclerView.Adapter<PhotoAdapterPANPatner1.PhotoViewHolder> {
    ...
    @NonNull
    @Override
    public PhotoAdapterPANPatner1.PhotoViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull PhotoAdapterPANPatner1.PhotoViewHolder holder, int position) {

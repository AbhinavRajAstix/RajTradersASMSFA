...
public class PhotoAdapterCheque extends RecyclerView.Adapter<PhotoAdapterCheque.PhotoViewHolder> {
    ...
    @NonNull
    @Override
    public PhotoAdapterCheque.PhotoViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull PhotoAdapterCheque.PhotoViewHolder holder, int position) {

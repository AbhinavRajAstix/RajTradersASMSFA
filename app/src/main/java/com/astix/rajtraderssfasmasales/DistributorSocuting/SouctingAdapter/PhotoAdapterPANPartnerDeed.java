...
public class PhotoAdapterPANPartnerDeed extends RecyclerView.Adapter<PhotoAdapterPANPartnerDeed.PhotoViewHolder> {
    ...
    @NonNull
    @Override
    public PhotoAdapterPANPartnerDeed.PhotoViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull PhotoAdapterPANPartnerDeed.PhotoViewHolder holder, int position) {

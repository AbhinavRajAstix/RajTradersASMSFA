...
public class PhotoAdapterPANPANPatner2 extends RecyclerView.Adapter<PhotoAdapterPANPANPatner2.PhotoViewHolder> {
    ...
    @NonNull
    @Override
    public PhotoAdapterPANPANPatner2.PhotoViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull PhotoAdapterPANPANPatner2.PhotoViewHolder holder, int position) {

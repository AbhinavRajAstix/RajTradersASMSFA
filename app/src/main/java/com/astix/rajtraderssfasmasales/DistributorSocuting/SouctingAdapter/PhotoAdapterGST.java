...
public class PhotoAdapterGST extends RecyclerView.Adapter<PhotoAdapterGST.PhotoViewHolder> {
    ...
    @NonNull
    @Override
    public PhotoAdapterGST.PhotoViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull PhotoAdapterGST.PhotoViewHolder holder, int position) {

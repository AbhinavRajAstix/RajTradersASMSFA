...
public class TblStoreListMasterDataRetrive {
    ...
    public int getFlgTCOrder() {
        return flgTCOrder;
    }

    public void setFlgTCOrder(int flgTCOrder) {
        this.flgTCOrder = flgTCOrder;
    }
    ...
    private int flgRemap;

    public int getFlgRemap() {
        return flgRemap;
    }

    public void setFlgRemap(int flgRemap) {
        this.flgRemap = flgRemap;
    }

    public int getDistanceNear() {
        return DistanceNear;
    }

    public void setDistanceNear(int distanceNear) {

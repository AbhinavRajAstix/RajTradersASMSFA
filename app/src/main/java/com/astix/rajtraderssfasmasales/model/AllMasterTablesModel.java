...
import com.astix.rajtraderssfasmasales.SchemeTablesModelsSaving.TblProductADDONScheme;
import com.astix.rajtraderssfasmasales.SchemeTablesModelsSaving.TblProductRelatedScheme;
import com.astix.rajtraderssfasmasales.SchemeTablesModelsSaving.TblSchemeMaster;
...
public class AllMasterTablesModel {
    ...
    @SerializedName("tblStoreTARSOrderDetails")
    @Expose
    private List<TblStoreTarsSummaryDetails> tblStoreTarsSummaryDetails = null;

    public List<TblStoreTarsSummaryDetails> getTblStoreTarsSummaryDetails() {
        return tblStoreTarsSummaryDetails;
    }

    public void setTblStoreTarsSummaryDetails(List<TblStoreTarsSummaryDetails> tblStoreTarsSummaryDetails) {
        this.tblStoreTarsSummaryDetails = tblStoreTarsSummaryDetails;
    }
...
*/
   /* tblIncentiveMainMaster
    ...
    @SerializedName("tblGatemeetingtgt")
    @Expose
    private List<TblPersonGateMeetingTarget> tblPersonGateMeetingTargetList = null;

    public List<TblPersonGateMeetingTarget> getTblPersonGateMeetingTargetList() {
        return tblPersonGateMeetingTargetList;
    }

    public void setTblPersonGateMeetingTargetList(List<TblPersonGateMeetingTarget> tblPersonGateMeetingTargetList) {
        this.tblPersonGateMeetingTargetList = tblPersonGateMeetingTargetList;
    }


    @SerializedName("tblPersonGateMeetingFocusedProductCoverageWiseMstrList")
    @Expose
    private List<TblPersonGateMeetingFocusedProductCoverageWiseMstr> tblPersonGateMeetingFocusedProductCoverageWiseMstrList = null;

    @SerializedName("tblDistRetAddressDetail")
    @Expose
    private List<TblPotentialDistributorRetailersFeedBackDetails> tblDistRetAddressDetailList = null;

    public List<TblPotentialDistributorRetailersFeedBackDetails> getTblDistRetAddressDetailList() {
        return tblDistRetAddressDetailList;
    }

    public void setTblDistRetAddressDetailList(List<TblPotentialDistributorRetailersFeedBackDetails> tblDistRetAddressDetailList) {
        this.tblDistRetAddressDetailList = tblDistRetAddressDetailList;
    }

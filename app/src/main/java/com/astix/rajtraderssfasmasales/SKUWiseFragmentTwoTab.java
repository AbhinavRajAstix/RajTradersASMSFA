...
public class SKUWiseFragmentTwoTab<Context> extends Fragment 
{
            ...
            Bundle savedInstanceState) 
    {
       ...
       imei = AppUtils.getToken(mContext);
		...
		int check=dbengine.fnCountToDisplayDailySummaryDetailsSKUWise(1,flgReportFromTmpOrPermanent,PersonNodeID,PersonNodeType);
		...
		else
		{
			...
			hmapAll_details=dbengine.fnGetDailySummaryDetailsSKUWiseCategoryLevel(1,flgReportFromTmpOrPermanent,PersonNodeID,PersonNodeType);

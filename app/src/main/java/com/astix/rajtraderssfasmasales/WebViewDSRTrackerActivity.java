...
public class WebViewDSRTrackerActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        String CoverageAreaNodeIDType= mDataSource.fngetSalesPersonCvrgIdCvrgNdTypByIMEITable();

        nid= Integer.parseInt(CoverageAreaNodeIDType.split(Pattern.quote("^"))[0]);
        ntype= Integer.parseInt(CoverageAreaNodeIDType.split(Pattern.quote("^"))[1]);

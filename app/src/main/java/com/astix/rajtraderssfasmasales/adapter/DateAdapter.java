...
import com.astix.rajtraderssfasmasales.model.TblBeatPlans;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
        ...
        switch (viewHolder.getItemViewType()) {
            ...
            case 2:
                ...
                tblBeatPlan.setRouteName(beatPlans.get(i).split(Pattern.quote("^"))[5]);
...
if(tblBeatPlan.getmDate().substring(0, 6).equals("29 Nov"))
{
    String sdsdsad="asdsad";
                ...
                dateViewHolder.actual_spoke_routename.setText(tblBeatPlan.getRouteName());
    ...
    public class DateViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView date_txt, spoke_txt, store_txt, day_txt,actual_spoke_routename;
        ...
        public DateViewHolder(@NonNull View itemView) {
            ...
            actual_spoke_routename = itemView.findViewById(R.id.actual_spoke_routename);

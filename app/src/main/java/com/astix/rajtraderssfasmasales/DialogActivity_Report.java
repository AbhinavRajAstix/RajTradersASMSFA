...
public class DialogActivity_Report extends BaseActivity
{
    ...
    private void getDSRDetail() throws IOException
    {
        ...
        tblSubordinateLists = mDataSource.getSubOrdinateListForDSRReport();
        hmapdsrIdAndDescr_details=mDataSource.fetch_DSRCoverage_List();

        int index=0;
        if(tblSubordinateLists!=null)
        {
            drsNames=new String[tblSubordinateLists.size()];
            for(TblSubordinateList tblSubordinateList:tblSubordinateLists)
            {
                drsNames[index]=tblSubordinateList.getPersonName().toString();
                index=index+1;
            }
    ...
    void initialize()
    {
        ...
        final RadioButton rb_dataReport= (RadioButton) findViewById(R.id.rb_dataReport);
        ...
        btn_proceed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                {
                    if(!SelectedDSRValue.equals("") && !SelectedDSRValue.equals("Select TSI") && !SelectedDSRValue.equals("No TSI") )
                    {
                ...
                else if(rb_dataReport.isChecked())
                {
                    Intent i = new Intent(DialogActivity_Report.this, WebViewDSRDataReportActivity.class);
                    startActivity(i);
                    finish();
                }
                else
        ...
        rb_dataReport.setOnClickListener(new View.OnClickListener() {
            @Override

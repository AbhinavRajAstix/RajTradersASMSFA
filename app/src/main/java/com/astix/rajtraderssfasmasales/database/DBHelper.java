package com.astix.rajtraderssfasmasales.database;
...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static final String Active_Cov = "Active_Cov";
    public static final String P3M = "P3M";
    public static final String New_Dstrbn = "New_Dstrbn";
    public static final String Dstrbn_Lost = "Dstrbn_Lost";
    ...
    public static final String TABLE_tblSummaryReportDetails="tblSummaryReportDetails";
    public static final String CREATE_TABLE_tblSummaryReportDetails ="CREATE TABLE "+
            TABLE_tblSummaryReportDetails+"("+
            Route+" TEXT ,"+
            Store+" TEXT);";
    ...
    public static final String CREATE_TABLE_REPORTDISTRIBUTION ="CREATE TABLE "+
            ...
            CoverageAreaNodeType+" INTEGER);";


    public static final String TABLE_REPORTDISTRIBUTION2x="tblRptDistribution2x";
    public static final String CREATE_TABLE_REPORTDISTRIBUTION2x ="CREATE TABLE "+
            TABLE_REPORTDISTRIBUTION2x+"("+
            DESCRIPTION+" TEXT ,"+
            YTD_TGT+" TEXT,"+
            YTD_TILLDATE+" TEXT,"+
            MTD+" TEXT,"+
    ...
    public static final String TABLE_RptSalesVersionIndivisual="tblRptSalesVersionIndivisual";
    public static final String CREATE_TABLE_RptSalesVersionIndivisual ="CREATE TABLE "+
            TABLE_RptSalesVersionIndivisual+"("+
            "PersonNodeID"+" TEXT ,"+
            "Description"+" TEXT,"+
            "DstrbnMTD_1"+" TEXT,"+
            "DstrbnYesterday_2"+" TEXT,"+
            "SalesMTD_3"+" TEXT,"+
            "SalesYesterday_4"+" TEXT,"+
            "VisitsYesterday_5"+" TEXT,"+
            flgLEVEL+" INTEGER,"+
            "Ordr"+" INTEGER,"+
            FLGCOLLAPSE+" INTEGER,"+
            SectionID+" INTEGER,"+
    ...
    public static final String TABLE_DSMSPersonStoreSummary="tblRptDSMSPersonStoreSummary";
    public static final String CREATE_TABLE_DSMSPersonStoreSummary ="CREATE TABLE "+
            TABLE_DSMSPersonStoreSummary+"("+
            "Description"+" TEXT ,"+
            "Planned"+" TEXT,"+
            "InFeildMTD"+" TEXT,"+
            "InFeildYesterDay"+" TEXT);";
    ...
    public static final String IN_Field_YTD_1    = "INFieldYTD_1";
    public static final String IN_Field_P3M_2    = "INFieldP3M_2";
    public static final String IN_Field_MTD_3    = "INFieldMTD_3";
    public static final String IN_Field_YESTERDAY_4    = "INFieldYESTERDAY_4";
    ...
    public static final String CREATE_TABLE_REPORTMANDAYS="CREATE TABLE "+
            TABLE_REPORTMANDAYS+"("+
            DESCRIPTION+" TEXT ,"+
            IN_Field_YTD_1+" INTEGER,"+
            IN_Field_P3M_2+" INTEGER,"+
            IN_Field_MTD_3+" INTEGER,"+
            IN_Field_YESTERDAY_4+" INTEGER,"+
            ValueType+" INTEGER,"+
            SectionID+" INTEGER,"+
            CoverageAreaNodeID+" INTEGER,"+
            CoverageAreaNodeType+" INTEGER);";
    ...
    public static final String ACTUAL_EXPECTED    = "Actual_Expected";
    public static final String ACTUAL_DONE    = "Actual_Done";

    public static final String DayWorkDate="DayWorkDate";
    public static final String TABLE_DAYWORKSUMMARY="tblDayWorkSummary";
    public static final String CREATE_TABLE_DAYWORKSUMMARY="CREATE TABLE "+
            TABLE_DAYWORKSUMMARY+"("+
            PERSONNODEID+" INTEGER, "+
            PERSONNODETYPE+" INTEGER, "+
            DayWorkDate+" TEXT, "+
            GROUPNAME+" TEXT ,"+
            DESCRIPTION+" TEXT ,"+
            PLANNED+" INTEGER,"+
    ...
    public static final String TABLE_STOREINVOICELASTVISITDETAILS="tblStoreInvoiceLastVisitDetails";
    public static final String CREATE_TABLE_STOREINVOICELASTVISITDETAILS="CREATE TABLE "+
            TABLE_STOREINVOICELASTVISITDETAILS+" ( "+
            STOREID+" INTEGER NOT NULL, "+
            INVCODE+" TEXT, "+
            INVDATE+" TEXT, "+
            OUTSTANDINGAMT+" REAL NOT NULL);";

    public static final String TABLE_STOREPRODUCTLVLORDERDETAIL="tblStoreProductLvlOrderDetail";
    public static final String CREATE_TABLE_STOREPRODUCTLVLORDERDETAIL="CREATE TABLE "+
            TABLE_STOREPRODUCTLVLORDERDETAIL+" ( "+
    ...
    public static final String FLGPERSONTYPE="flgPersonType";
    public static final String PARENTPERSONTYPE="ParentPersonType";
    public static final String FLGMARKETVISITSTARTED="flgMarketVisitStarted";
    public static final String PARENTPERSONID="ParentPersonID";
    ...
    public static final String TABLE_SUBORDINATELIST="tblSubordinateList";
    ...
    public static final String TABLE_tblVisitJointSignature = "tblVisitJointSignature";
    public static final String DATABASE_CREATE_tblVisitJointSignature = "create table tblVisitJointSignature(StoreID text null,JointVisitId text null,flgType text null,ImageType int null,ImageClicktime text null,ImageName text null,ImagePath text null,Sstat integer null,StoreVisitCode text null,flgApplicablemodule int null,PersonNodeID int null,PersonNodeType int null);";



    public static final String TABLE_tblDistributorDailyStockDetailsReport = "tblDistributorDailyStockDetailsReport";
    public static final String DATABASE_CREATE_TABLE_tblDistributorDailyStockDetailsReport = "create table tblDistributorDailyStockDetailsReport (CustomerNodeID int not null,CustomerNodeType int not null,Customer text null, PersonName text null,LastEntryDate text null,StockKg real null,StockCases real null,StockValue real null);";

    public static final String TABLE_tblDistributorDailyStockDetailsSKUReport = "tblDistributorDailyStockDetailsSKUReport";
    public static final String DATABASE_CREATE_TABLE_tblDistributorDailyStockDetailsSKUReport = "create table tblDistributorDailyStockDetailsSKUReport (CustomerNodeID int not null,CustomerNodeType int not null,CategoryNodeID int null, CategoryNodeType int null,Category text null,ProductNodeID int null,ProductNodeType int null,SKUName text null,StockKgQty real null,StockCaseQty real null,StockValue real null);";
    ...
    public static final String DATABASE_CREATE_TABLE_tblCoverageDsr= "create table tblRoutelist (CoverageAreaNodeID text null, CoverageAreaNodeType text null, CoverageArea text null," +
            "PersonNodeID text null, PersonNodeType text null, PersonName text null, RouteNodeID text null, RouteNodeType text null, Route text null, Active text null, flgTodayRoute int  null,DBNodeID int null);";

    public static final String CREATE_TABLE_SUBORDINATELIST="CREATE TABLE "+
            TABLE_SUBORDINATELIST+" ( "+
            FLGPERSONTYPE+" INTEGER NOT NULL, "+
            PARENTPERSONTYPE+" INTEGER NOT NULL, "+
            FLGMARKETVISITSTARTED+" INTEGER NOT NULL, "+
            PERSONNODETYPE+" INTEGER NOT NULL, "+
            PERSONNAME+" TEXT, "+
            COVERAGEAREA+" TEXT, "+
            PERSONNODEID+" INTEGER NOT NULL, "+
            PARENTPERSONID+" INTEGER NOT NULL," +
            CoverageAreaNodeID+" INTEGER NOT NULL," +
            CoverageAreaNodeType+" INTEGER NOT NULL," +
    ...
    public static final String CREATE_TABLE__JOINTVISITMASTER ="CREATE TABLE "+
            ...
            ROUTETYPE+" TEXT null, "+
                COVERAGEAREANODEID+" INTEGER null, "+
            COVERAGETYPE+" TEXT null,"+
            VISITDATE+" TEXT null,"+
            VISITSTARTTIME+" TEXT null,"+
            VISITENDTIME+" TEXT null,"+
            MAPADDRESS+" TEXT null,"+
            MAPPINCODE+" INTEGER null,"+
            MAPCITY+" TEXT null,"+
            MAPSTATE+" TEXT null,"+
            ACTUALLATITUDE+" REAL null,"+
            ACTUALLONGITUDE+" REAL null,"+
            LOCPROVIDER+" TEXT null,"+
            ACCURACY+" INTEGER null,"+
            TIMESTAMPIN+" TEXT null,"+
            ALLPROVIDERDATA+" TEXT null,"+
            GPSLATITUDE+" REAL null,"+
            GPSLONGITUDE+" REAL null,"+
            GPSACCURACY+" INTEGER null,"+
            GPSADDRESS+" TEXT null,"+
            NETWORKLATITUDE+" REAL null,"+
            NETWORKLONGITUDE+" REAL null,"+
            NETWORKACCURACY+" INTEGER null,"+
            NETWORKADDRESS+" TEXT null,"+
            FUSEDLATITUDE+" REAL null,"+
            FUSEDLONGITUDE+" REAL null,"+
            FUSEDACCURACY+" INTEGER null,"+
            FUSEDADDRESS+" INTEGER null,"+
            FLGLOCATIONSERVICESONOFF+" INTEGER null,"+
            FLGGPSONOFF+" INTEGER null,"+
            FLGNETWORKONOFF+" INTEGER null,"+
            FLGFUSEDONOFF+" INTEGER null,"+
            FLGINTERNETONOFFWHILELOCATIONTRACKING+" INTEGER null,"+
            FLGREBOOT+" INTEGER null,"+
    ...
    public static final String CREATE_TABLE_JOINTVISITDETAILS ="CREATE TABLE "+
            ...
            JOINTVISITID+" TEXT null,"+
            FELLOWPERSONNODEID+" INTEGER null,"+
            FELLOWPERSONNAME+" TEXT null,"+
            SSTAT+" INTEGER null,"+
            FELLOWPERSONNODETYPE+" TEXT null);";
    ...
    public static final String DATABASE_CREATE_TABLE_tblAppliedOrderDiscount = "create table " + DATABASE_TABLE_tblAppliedOrderDiscount + " (StoreID text null,InvoiceNumber text null,PrdID int,UOMID int null,RelConversionUnits int null,TotalDisc real null,DiscountperUOM real null,CoverageAreaNodeID int null,CoverageAreaNodeType int null);";
    ...
    public static final String DATABASE_CREATE_TABLE_tblStoreSummaryDetails = "create table " + DATABASE_TABLE_tblStoreSummaryDetails + " (StoreID text null,OrderID text,VisitID integer,InvDate text,ProductID integer,OrderQty int null, NetLineOrderVal text null,NetOrderValue text null,CoverageAreaNodeID int null,CoverageAreaNodeType int null);";


    public static final String DATABASE_TABLE_tblStoreTarsSummaryDetails = "tblStoreTarsSummaryDetails";
    public static final String DATABASE_CREATE_TABLE_tblStoreTarsSummaryDetails = "create table " + DATABASE_TABLE_tblStoreTarsSummaryDetails + " (StoreID text null,OrderID text,InvDate text,ProductID int,OrderQty int null, NetLineOrderVal text null,NetOrderValue text null,CoverageAreaNodeID int null,CoverageAreaNodeType int null);";


    public static final String DATABASE_TABLE_tblOrderHistory = "tblOrderHistory";
    public static final String DATABASE_CREATE_TABLE_tblOrderHistory = "create table " + DATABASE_TABLE_tblOrderHistory + " (StoreID integer, OrderID integer, flgOrderSource integer, InvDate text null,OrderValue text null, OrderQty float,CoverageAreaNodeID int null,CoverageAreaNodeType int null);";

    public static final String TABLE_tblPersonGateMeetingTargetMstr = "tblPersonGateMeetingTargetMstr";
    public static final String DATABASE_CREATE_TABLE_tblPersonGateMeetingTargetMstr = "create table tblPersonGateMeetingTargetMstr (CovAreaNodeID text null,CovAreaNodeType text null,CovArea text null,PersonNodeID text null,PersonNodeType text null,Personname text null,Dstrbn_Tgt real null,Sales_Tgt real null,MonthTarget real null,Achievement real null,RRRequired real null,TodaysStore real null,ProdStoreLastCall real null,LastRouteVisitDate text null,TodaysRouteNodeID int null,TodaysRouteNodeType int null);";


    public static final String TABLE_tblPersonGateMeetingFocusedProductCoverageWiseMstr = "tblPersonGateMeetingFocusedProductCoverageWiseMstr";
    public static final String DATABASE_CREATE_TABLE_tblPersonGateMeetingFocusedProductCoverageWiseMstr = "create table tblPersonGateMeetingFocusedProductCoverageWiseMstr (CovAreaNodeID text null,CovAreaNodeType text null,CovArea text null,FocusProductNodeID int null,FocusProductNodeType int null,FocusProduct real null,Dstrbn_Tgt_Focus real null,Sales_Tgt_Focus real null);";

    public static final String TABLE_tblPersonGateMeetingFocusedProductCoverageWiseDetails = "tblPersonGateMeetingFocusedProductCoverageWiseDetails";
    public static final String DATABASE_CREATE_TABLE_tblPersonGateMeetingFocusedProductCoverageWiseDetails = "create table tblPersonGateMeetingFocusedProductCoverageWiseDetails (CovAreaNodeID text null,CovAreaNodeType text null,CovArea text null,FocusProductNodeID int null,FocusProductNodeType int null,FocusProduct real null,Dstrbn_Tgt_Focus real null,Sales_Tgt_Focus real null,Sstat int null,PersonNodeID text null,PersonNodeType  text null,PDACode text null,EntryDate  text null);";


    public static final String TABLE_tblPersonGateMeetingTargetDetails = "tblPersonGateMeetingTargetDetails";
    public static final String DATABASE_CREATE_TABLE_tblPersonGateMeetingTargetDetails = "create table tblPersonGateMeetingTargetDetails (CovAreaNodeID text null,CovAreaNodeType text null,CovArea text null,PersonNodeID text null,PersonNodeType text null,Personname text null,Dstrbn_Tgt real null,Sales_Tgt real null,Sstat int null,MonthTarget real null,Achievement real null,RRRequired real null,TodaysStore real null,ProdStoreLastCall real null,LastRouteVisitDate text null,TodaysRouteNodeID int null,TodaysRouteNodeType int null,EntryDate  text null);";
    ...
    public static final String DATABASE_CREATE_TABLE_tblStoreListForUpdateMstr = "create table tblStoreListForUpdateMstr (StoreID text null,StoreName text null,StoreLat text null,StoreLong text null,Ownername text null,Contactnumber text null,Address text null,Reasonforupdate text null,RouteNodeID int null,RouteNodeType int null,UpdatedContactnumber text null,flgMapped int null,OTP text null,Sstat int null,Distance real null,CoverageAreaNodeID int null,CoverageAreaNodeType int null);";


    public static final String DATABASE_TblStoreSuggestedQtyMstr = "tblStoreSuggestedQtyMstr";
    public static final String DATABASE_CREATE_TblStoreSuggestedQtyMstr = "create table tblStoreSuggestedQtyMstr (StoreID text null,PrdNodeId int null,SuggestedQty int null,CoverageAreaNodeID int null,CoverageAreaNodeType int null);";

    public static final String DATABASE_tblReplenishmentSKU = "tblReplenishmentSKU";
    public static final String DATABASE_CREATE_tblReplenishmentSKU = "create table tblReplenishmentSKU (StoreID text null,PrdNodeId int null,CoverageAreaNodeID int null,CoverageAreaNodeType int null);";


    public static final String DATABASE_tblFocusbrandSKU = "tblFocusbrandSKU";
    public static final String DATABASE_CREATE_tblFocusbrandSKU = "create table tblFocusbrandSKU (StoreID text null,PrdNodeId int null,CoverageAreaNodeID int null,CoverageAreaNodeType int null);";
    ...
    public static final String DATABASE_CREATE_TABLE_tblPDAStoreSummary = "create table " + DATABASE_TABLE_tblPDAStoreSummary + " (StoreID text null,MonthlyTarget integer,VisitTarget integer,Achieved integer,Balance integer,CoverageAreaNodeID int null,CoverageAreaNodeType int null);";

    public static final String DATABASE_TABLE_tblPDAStoreVisitHistory = "tblPDAStoreVisitHistory";
    public static final String DATABASE_CREATE_TABLE_tblPDAStoreVisitHistory = "create table " + DATABASE_TABLE_tblPDAStoreVisitHistory + " (StoreID text null, ContactedBy text null,LastCallVisit text null,OrderValue text null,OrderQty text null,OrderStatus text null,CoverageAreaNodeID int null,CoverageAreaNodeType int null);";

    public static final String DATABASE_TABLE_tblStoreTARSSummary = "tblStoreTARSSummary";
    public static final String DATABASE_CREATE_TABLE_tblStoreTARSSummary = "create table " + DATABASE_TABLE_tblStoreTARSSummary + " (StoreID text null, ContactedBy text null,LastCallVisit text null,OrderValue text null,OrderQty text null,OrderStatus text null,CoverageAreaNodeID int null,CoverageAreaNodeType int null);";

    public static final String DATABASE_TABLE_tblProductLevelData = "tblProductLevelData";
    public static final String DATABASE_CREATE_TABLE_tblProductLevelData = "create table " + DATABASE_TABLE_tblProductLevelData + " (StoreID int null, PrdNodeId int null,InvDate text null,OrderValue text null, OrderID text null, Qty text null,CoverageAreaNodeID int null,CoverageAreaNodeType int null);";
    ...
    public static final String DATABASE_CREATE_TABLEtblProductListLastVisitStockOrOrderMstr = "create table tblProductListLastVisitStockOrOrderMstr (StoreID text not null,OrderDate text null,PrdID text not null,OrderValue Text null,CoverageAreaNodeID int null, CoverageAreaNodeType int null);";
    ...
    public static final String DATABASE_CREATE_TABLE_tblLastOutstanding = "create table tblLastOutstanding(StoreID text not null,Outstanding real not null,AmtOverdue real not null,CoverageAreaNodeID int null,CoverageAreaNodeType int null);";
    public static final String DATABASE_TABLE_tblInvoiceLastVisitDetails = "tblInvoiceLastVisitDetails";
    public static final String DATABASE_CREATE_TABLE_tblInvoiceLastVisitDetails = "create table tblInvoiceLastVisitDetails(StoreID text not null,InvCode text null,InvDate text null,OutstandingAmt text not null,AmtOverdue text null,CoverageAreaNodeID int null,CoverageAreaNodeType int null);";
    ...
    public static final String DATABASE_CREATE_TABLE_Image = "create table tableImage(StoreID text null,QstIdAnsCntrlTyp text null,imageName text null,imagePath text null,ImageClicktime text null,Sstat integer null,flgApplicablemodule int null);";


    public static final String TABLE_OutletQuestAnsMstr = "tblOutletQuestAnsMstr";
    public static final String DATABASE_CREATE_TABLE_tblOutletQuestAnsMstr = "create table tblOutletQuestAnsMstr (OutletID text not null,QuestID text not null,AnswerType text null, AnswerValue text null,QuestionGroupID integer null,sectionID integer null,Sstat integer not null,JointVisitID text null,flgApplicablemodule integer null);";
    ...
    public static final String DATABASE_StoreAddressMapDetailsMstr = "create table tblStoreAddressMapDetailsMstr (StoreID text not null,OutAddTypeID int not null,Address text not null,AddressDet text null,OutAddID int not null,CoverageAreaNodeID int null, CoverageAreaNodeType int null);";
    ...
    public static final String DATABASE_CREATE_TABLE_201 = "create table tblSchemeStoreMapping (StoreID text null,SchemeID text null,IsNewStore int null,CoverageAreaNodeID int null,CoverageAreaNodeType int null);";
    ...
    public static final String DATABASE_CREATE_TABLE_103 = "create table tblPDAGetLODQty(StoreID text not null,Date text null,SKUID text not null,Qty integer null,SKUName text not null,CoverageAreaNodeID int null,CoverageAreaNodeType int null);";
    ...
    public static final String DATABASE_CREATE_TABLE_141 = "create table tblPDAGetLastVisitDate(StoreID text not null,VisitDate text not null,flgOrder text null,CoverageAreaNodeID int null,CoverageAreaNodeType int null);";
    ...
    public static final String DATABASE_CREATE_TABLE_142 = "create table tblPDAGetLastOrderDate(StoreID text not null,OrderDate text not null,flgExecutionSummary text not null,CoverageAreaNodeID int null,CoverageAreaNodeType int null);";
    public static final String DATABASE_CREATE_TABLE_143 = "create table tblPDAGetLastVisitDetails(StoreID text not null,Date123 text null,Order123 text null,Stock text null,SKUName text not null,ExecutionQty text null,ProductID text not null,CoverageAreaNodeID int null,CoverageAreaNodeType int null);";
    ...
    public static final String DATABASE_CREATE_TABLE_144 = "create table tblPDAGetLastOrderDetails(StoreID text not null,OrderDate text not null,ProductID text not null,OrderQty text not null,FreeQty text null,PrdName text null,ExecutionQty text null,CoverageAreaNodeID int null,CoverageAreaNodeType int null);";
    public static final String DATABASE_CREATE_TABLE_145 = "create table tblPDAGetLastOrderDetailsTotalValues(StoreID text not null,OrderValue text not null,ExecutionValue text null,CoverageAreaNodeID int null,CoverageAreaNodeType int null);";
    public static final String DATABASE_CREATE_TABLE_146 = "create table tblPDAGetExecutionSummary(StoreID text not null,OrderDate text not null,ProductID text not null,OrderQty text not null,flgInvStatus text not null,ProductQty text not null,PrdName text not null,OrderDate1 text not null,CoverageAreaNodeID int null,CoverageAreaNodeType int null);";
    ...
    public void onCreate(SQLiteDatabase db) {
      //  try {
        ...
        db.execSQL(CREATE_TABLE_tblSummaryReportDetails);
        db.execSQL(DATABASE_CREATE_tblVisitJointSignature);
        ...
        db.execSQL(DATABASE_CREATE_TABLE_tblDistributorDailyStockDetailsReport);
        db.execSQL(DATABASE_CREATE_TABLE_tblDistributorDailyStockDetailsSKUReport);
        db.execSQL(DATABASE_CREATE_TABLE_tblStoreTarsSummaryDetails);
        db.execSQL(DATABASE_CREATE_TABLE_tblPersonGateMeetingTargetMstr);
        db.execSQL(DATABASE_CREATE_TABLE_tblPersonGateMeetingFocusedProductCoverageWiseMstr);
        db.execSQL(DATABASE_CREATE_TABLE_tblPersonGateMeetingFocusedProductCoverageWiseDetails);

        db.execSQL(DATABASE_CREATE_TABLE_tblPersonGateMeetingTargetDetails);
        db.execSQL(CREATE_TABLE_DAYWORKSUMMARY);
        db.execSQL(CREATE_TABLE_REPORTDISTRIBUTION);
        db.execSQL(CREATE_TABLE_REPORTDISTRIBUTION2x);
       db.execSQL(CREATE_TABLE_RptSalesVersionIndivisual);
       // db.execSQL(CREATE_TABLE_DSMSPersonStoreSummary);
        db.execSQL(CREATE_TABLE_REPORTSECTIONVOL);
        db.execSQL(CREATE_TABLE_REPORTPRIMARYVOL);
        db.execSQL(CREATE_TABLE_REPORTMANDAYS);

        db.execSQL(CREATE_TABLE_STOREINVOICELASTVISITDETAILS);
        db.execSQL(CREATE_TABLE_STOREPRODUCTLVLORDERDETAIL);
        ...
        db.execSQL(CREATE_TABLE_SUBORDINATELIST);

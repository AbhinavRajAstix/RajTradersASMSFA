...
import com.astix.rajtraderssfasmasales.model.TblStoreSKUWiseDaySummary;
...
*/
		...
		SharedPreferences sharedPref = getActivity().getBaseContext().getSharedPreferences(CommonInfo.Preference, MODE_PRIVATE);
		int flgDataScope=0;

...
import static com.allana.truetime.TimeUtils.getCurrentDeviceDateTime;
import static com.astix.Common.CommonInfo.RegistrationID;


public class ReportsActivity extends BaseActivity implements MultipleInterfaceRetrofit {
    ...
    public void success(int flgCalledFrom) {
      ...
      YesterdayReportFragment fest= (YesterdayReportFragment) getSupportFragmentManager().findFragmentByTag(YESTERDAY_REPORT);
        if (fest != null) {
            fest.fnRefreshDownloadedDataAgainstPerson(flgCalledFrom);
        }

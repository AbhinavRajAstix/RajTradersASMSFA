...
public class SKUWiseFragmentThreeTab<Context> extends Fragment 
{
            ...
            Bundle savedInstanceState) 
    {
       ...
       // TelephonyManager tManager = (TelephonyManager) mContext.getSystemService(mContext.TELEPHONY_SERVICE);
		...
		int check=dbengine.fnCountToDisplayDailySummaryDetailsSKUWise(5,flgReportFromTmpOrPermanent,PersonNodeID,PersonNodeType);
		...
		{
			hmapAll_details=dbengine.fnGetDailySummaryDetailsSKUWiseCategoryLevel(5,flgReportFromTmpOrPermanent,PersonNodeID,PersonNodeType);

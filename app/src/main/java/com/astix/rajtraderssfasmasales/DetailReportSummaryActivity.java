...
import com.astix.rajtraderssfasmasales.model.TblDailyDateWiseSalesManTargetVsAch;
import com.astix.rajtraderssfasmasales.model.TblDayWiseActualVsTargetReportSalesMan;
	...
	public void success() {
		if(isOnline())
		{
			...
			try
			{
				...
				CommonFunction.DateWiseTargetVsAchReportDownload reportDownloadAsyncTask = new CommonFunction.DateWiseTargetVsAchReportDownload(DetailReportSummaryActivity.this, mProgressDialogReport, interfaceRetrofit,PersonNodeId,PersonNodeType,0);

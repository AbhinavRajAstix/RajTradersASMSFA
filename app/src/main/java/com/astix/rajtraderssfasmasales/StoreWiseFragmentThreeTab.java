...
public class StoreWiseFragmentThreeTab<Context> extends Fragment
{
            ...
            Bundle savedInstanceState) 
    {
      ...
      int check=dbengine.fnCountToDisplayDailySummaryDetailsStoreWiseLines(5,flgReportFromTmpOrPermanent,PersonNodeID,PersonNodeType);
      //dbengine.close();
		...
		{
			////dbengine.open();
			hmapAll_details=dbengine.fnGetDailySummaryDetailsStoreWise(5,flgReportFromTmpOrPermanent,PersonNodeID,PersonNodeType);
			////dbengine.close();
            intializeFields();
		}

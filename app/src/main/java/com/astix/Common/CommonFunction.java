...
import com.astix.rajtraderssfasmasales.DistributorSocuting.ScoutInterface.InterfaceServerSuccessDistributorDeletion;
import com.astix.rajtraderssfasmasales.DistributorSocuting.ScoutInterface.InterfaceServerSuccessEntry;
import com.astix.rajtraderssfasmasales.DistributorSocuting.ScoutInterface.InterfaceServerSuccessRetailerFeedBackEntry;
...
import com.astix.rajtraderssfasmasales.DistributorSocuting.ScoutingModels.TblPotentialDistributorVehicleMasterList;
...
import com.astix.rajtraderssfasmasales.InterfaceRetrofitAttendanceMarking;
import com.astix.rajtraderssfasmasales.InterfaceRetrofitDistributorPersonStockDetails;
import com.astix.rajtraderssfasmasales.InterfaceRetrofitNewStoreNumberValidation;
import com.astix.rajtraderssfasmasales.InterfaceRetrofitOrderOnMain;
import com.astix.rajtraderssfasmasales.MultipleInterfaceForDayEndStatus;
import com.astix.rajtraderssfasmasales.MultipleInterfaceRetrofit;
import com.astix.rajtraderssfasmasales.SaveStoreListDataAsync;
import com.astix.rajtraderssfasmasales.SchemeTablesModelsSaving.TblProductRelatedScheme;
import com.astix.rajtraderssfasmasales.SchemeTablesModelsSaving.TblSchemeMstr;
import com.astix.rajtraderssfasmasales.SchemeTablesModelsSaving.TblSchemeSlabBenefitsBucketDetails;
import com.astix.rajtraderssfasmasales.SchemeTablesModelsSaving.TblSchemeSlabBenefitsProductMappingDetail;
import com.astix.rajtraderssfasmasales.SchemeTablesModelsSaving.TblSchemeSlabBenefitsValueDetail;
import com.astix.rajtraderssfasmasales.SchemeTablesModelsSaving.TblSchemeSlabBucketDetails;
import com.astix.rajtraderssfasmasales.SchemeTablesModelsSaving.TblSchemeSlabBucketProductMapping;
import com.astix.rajtraderssfasmasales.SchemeTablesModelsSaving.TblSchemeSlabDetail;
import com.astix.rajtraderssfasmasales.SchemeTablesModelsSaving.TblSchemeStoreMapping;
import com.astix.rajtraderssfasmasales.database.AppDataSource;
import com.astix.rajtraderssfasmasales.R;
import com.astix.rajtraderssfasmasales.model.*;
...
public class CommonFunction {
    ...
    public static void getAllMasterTableModelData(Context context, final String imei, String RegistrationID, String msgToShow, final int flgCldFrm) {
      ...
      /*  String prsnCvrgId_NdTyp = dbengine.fngetSalesPersonCvrgIdCvrgNdTyp();
        ...
        String  CoverageNodeId="";//+sharedPref.getInt("CoverageAreaNodeID",0);
        String CoverageNodeType="";//+sharedPref.getInt("CoverageAreaNodeType",0);
        if(sharedPref!=null && sharedPref.contains("CoverageAreaNodeID"))
        {
             CoverageNodeId=""+sharedPref.getInt("CoverageAreaNodeID",0);
             CoverageNodeType=""+sharedPref.getInt("CoverageAreaNodeType",0);
             if(CoverageNodeId.equals("0"))
             {
                 String prsnCvrgId_NdTyp = dbengine.fngetSalesPersonCvrgIdCvrgNdTypForAllMasterData();
                 CoverageNodeId =prsnCvrgId_NdTyp.split(Pattern.quote("^"))[0];
                 CoverageNodeType = prsnCvrgId_NdTyp.split(Pattern.quote("^"))[1];
                 CommonInfo.CoverageAreaNodeID=Integer.parseInt(CoverageNodeId);
                 CommonInfo.CoverageAreaNodeType=Integer.parseInt(CoverageNodeType);

                 //sPref
                 /*SharedPreferences.Editor editor = sharedPref.edit();

                 editor.putInt("CoverageAreaNodeID", Integer.parseInt(CoverageNodeId));
                 editor.putInt("CoverageAreaNodeType", Integer.parseInt(CoverageNodeType));
                 editor.commit();*/
             }
        }
        else
       ...
       // data.setRegistrationId(RegistrationID);
        ...
        String finalCoverageNodeType = CoverageNodeType;
        String finalCoverageNodeId = CoverageNodeId;
...
//                            }
                    ...
                    if (tblCoverageDsr!=null && tblCoverageDsr.size() > 0) {
                        ...
                        dbengine.insertintotblCoveragedsr(tblCoverageDsr,Integer.parseInt(finalCoverageNodeId),Integer.parseInt(finalCoverageNodeType));
                    } else {
                    ...
                    if (tblCoverageMaster!=null && tblCoverageMaster.size() > 0) {
                        ...
                        dbengine.insertintotblCoverageMstr(tblCoverageMaster,Integer.parseInt(finalCoverageNodeId),Integer.parseInt(finalCoverageNodeType));
                    } else {
...
//                            }
                    ...
                    if (allMasterTablesModel.getTblStoreSuggestedQtyMstrList() != null) {
                        dbengine.Delete_tblStoreSuggestedQtyMstrList(Integer.parseInt(finalCoverageNodeId),Integer.parseInt(finalCoverageNodeType));
                        ...
                        if (tblStoreSuggestedQtyMstrsList.size() > 0) {
                            dbengine.saveTblStoreSuggestedQtyMstrList(tblStoreSuggestedQtyMstrsList,Integer.parseInt(finalCoverageNodeId),Integer.parseInt(finalCoverageNodeType));
                        } else {
                    ...
                    if (allMasterTablesModel.getTblFocusbrandSKUMstrList() != null) {
                        dbengine.Delete_tblFocusbrandSKU(Integer.parseInt(finalCoverageNodeId),Integer.parseInt(finalCoverageNodeType));
                        ...
                        if (tblFocusbrandSKUMstrList.size() > 0) {
                            dbengine.saveTblFocusbrandSKUMstrListt(tblFocusbrandSKUMstrList,Integer.parseInt(finalCoverageNodeId),Integer.parseInt(finalCoverageNodeType));
                        } else {
                    ...
                    if (allMasterTablesModel.getTblReplenishmentSKUList() != null) {
                        dbengine.Delete_tblReplenishmentSKU(Integer.parseInt(finalCoverageNodeId),Integer.parseInt(finalCoverageNodeType));
                        ...
                        if (tblReplenishmentSKUList.size() > 0) {
                            dbengine.saveTblReplenishmentSKUMstrListt(tblReplenishmentSKUList,Integer.parseInt(finalCoverageNodeId),Integer.parseInt(finalCoverageNodeType));
                    ...
                    if (allMasterTablesModel.getTblUOMMapping() != null) {
                        ...
                        if (tblUOMMapping.size() > 0) {
                           /* for (TblUOMMapping UOMMapping : tblUOMMapping) {
                                dbengine.insertUOMMapping(UOMMapping.getNodeID(), UOMMapping.getNodeType(), UOMMapping.getBaseUOMID(), UOMMapping.getPackUOMID(), UOMMapping.getRelConversionUnits(), UOMMapping.getFlgIsDefaultUOM());
                            }*/

                            dbengine.insertUOMMapping(tblUOMMapping);
...
*/
                    if (allMasterTablesModel.getTblSchemeStoreMapping() != null && allMasterTablesModel.getTblSchemeStoreMapping().size() > 0) {
                        dbengine.Delete_tblStoreProductMap_for_refreshData(Integer.parseInt(finalCoverageNodeId),Integer.parseInt(finalCoverageNodeType));
                        ...
                        if (tblSchemeStoreMappings != null && tblSchemeStoreMappings.size() > 0) {
                            dbengine.savetblSchemeStoreMapping(tblSchemeStoreMappings,Integer.parseInt(finalCoverageNodeId),Integer.parseInt(finalCoverageNodeType));
                        } else {
...
*/
                    ...
                    if (allMasterTablesModel.getTblLastOutstanding() != null) {
                        dbengine.Delete_tblLastOutstanding_for_refreshData(Integer.parseInt(finalCoverageNodeId),Integer.parseInt(finalCoverageNodeType));
                        //deleted above
                        List<TblLastOutstanding> tblLastOutstanding = allMasterTablesModel.getTblLastOutstanding();

                        if (tblLastOutstanding.size() > 0) {

                            dbengine.savetblLastOutstanding(tblLastOutstanding,Integer.parseInt(finalCoverageNodeId),Integer.parseInt(finalCoverageNodeType));
                    ...
                    if (allMasterTablesModel.getTblInvoiceLastVisitDetails() != null) {
                        ...
                        if (tblInvoiceLastVisitDetails.size() > 0) {
                            ...
                            dbengine.savetblInvoiceLastVisitDetails(tblInvoiceLastVisitDetails,Integer.parseInt(finalCoverageNodeId),Integer.parseInt(finalCoverageNodeType));
                    ...
                    if (allMasterTablesModel.getTblPDAGetExecutionSummary() != null) {
                        dbengine.deltblPDAGetExecutionSummary(Integer.parseInt(finalCoverageNodeId),Integer.parseInt(finalCoverageNodeType));
                        //deleted above
                        ...
                        if (tblPDAGetExecutionSummary.size() > 0) {
                            ...
                            dbengine.inserttblForPDAGetExecutionSummary(tblPDAGetExecutionSummary,Integer.parseInt(finalCoverageNodeId),Integer.parseInt(finalCoverageNodeType));
                    ...
                    if (allMasterTablesModel.getTblPDAGetLastOrderDetailsTotalValues() != null) {
                        dbengine.deletetblPDAGetLastOrderDetailsTotalValues(Integer.parseInt(finalCoverageNodeId),Integer.parseInt(finalCoverageNodeType));
                        //deleted above
                        ...
                        if (tblPDAGetLastOrderDetailsTotalValues.size() > 0) {
                            ...
                            dbengine.inserttblspForPDAGetLastOrderDetails_TotalValues(tblPDAGetLastOrderDetailsTotalValues,Integer.parseInt(finalCoverageNodeId),Integer.parseInt(finalCoverageNodeType));
                    ...
                    if (allMasterTablesModel.getTblPDAGetLastOrderDetails() != null) {
                        dbengine.deltblPDAGetLastOrderDetailsData(Integer.parseInt(finalCoverageNodeId),Integer.parseInt(finalCoverageNodeType));
                        //deleted above
                        ...
                        if (tblPDAGetLastOrderDetails.size() > 0) {
                            dbengine.inserttblForPDAGetLastOrderDetails(tblPDAGetLastOrderDetails,Integer.parseInt(finalCoverageNodeId),Integer.parseInt(finalCoverageNodeType));
                        } else {
                    ...
                    if (allMasterTablesModel.getTblPDAGetLastVisitDetails() != null) {
                        dbengine.deletetblPDAGetLastVisitDetails(Integer.parseInt(finalCoverageNodeId),Integer.parseInt(finalCoverageNodeType));
                        //deleted above
                        ...
                        if (tblPDAGetLastVisitDetails.size() > 0) {
                            ...
                            dbengine.inserttblForPDAGetLastVisitDetails(tblPDAGetLastVisitDetails,Integer.parseInt(finalCoverageNodeId),Integer.parseInt(finalCoverageNodeType));
                    ...
                    if (allMasterTablesModel.getTblPDAGetLastOrderDate() != null) {
                        dbengine.deletetblPDAGetLastOrderDateData(Integer.parseInt(finalCoverageNodeId),Integer.parseInt(finalCoverageNodeType));
                        //deleted above
                        ...
                        if (tblPDAGetLastOrderDate.size() > 0) {
                            ...
                            dbengine.inserttblForPDAGetLastOrderDate(tblPDAGetLastOrderDate,Integer.parseInt(finalCoverageNodeId),Integer.parseInt(finalCoverageNodeType));
                    ...
                    if (allMasterTablesModel.getTblPDAGetLastVisitDate() != null) {
                        dbengine.deletetblPDAGetLastVisitDate(Integer.parseInt(finalCoverageNodeId),Integer.parseInt(finalCoverageNodeType));
                        //deleted above
                        ...
                        if (tblPDAGetLastVisitDate.size() > 0) {
                            ...
                            dbengine.inserttblForPDAGetLastVisitDate(tblPDAGetLastVisitDate,Integer.parseInt(finalCoverageNodeId),Integer.parseInt(finalCoverageNodeType));
                    ...
                    if (allMasterTablesModel.getTblPDAGetLODQty() != null) {
                        dbengine.deletetblPDAGetLODQty(Integer.parseInt(finalCoverageNodeId),Integer.parseInt(finalCoverageNodeType));
                        //deleted above
                        List<TblPDAGetLODQty> tblPDAGetLODQty = allMasterTablesModel.getTblPDAGetLODQty();

                        if (tblPDAGetLODQty.size() > 0) {

                            dbengine.inserttblLODOnLastSalesSummary(tblPDAGetLODQty,Integer.parseInt(finalCoverageNodeId),Integer.parseInt(finalCoverageNodeType));
                    ...
                    if (allMasterTablesModel.getTblProductListLastVisitStockOrOrderMstr() != null) {
                        dbengine.deletetblProductListLastVisitStockOrOrderMstr(Integer.parseInt(finalCoverageNodeId),Integer.parseInt(finalCoverageNodeType));
                        //deleted above
                        ...
                        if (tblProductListLastVisitStockOrOrderMstr.size() > 0) {
                            ...
                            dbengine.savetblProductListLastVisitStockOrOrderMstr(tblProductListLastVisitStockOrOrderMstr,Integer.parseInt(finalCoverageNodeId),Integer.parseInt(finalCoverageNodeType));
                    ...
                    if (allMasterTablesModel.getTblStoreListForUpdateMstr() != null) {
                        ...
                        if (tblStoreListForUpdateMstrList.size() > 0) {
                            dbengine.fnInsertOrUpdate_tblStoreListForUpdateMstr(tblStoreListForUpdateMstrList, hmapStoreListForUpdateMstrList,Integer.parseInt(finalCoverageNodeId),Integer.parseInt(finalCoverageNodeType));
                        } else {
                    ...
                    if (allMasterTablesModel.getTblStoreListWithPaymentAddress() != null) {
                        ...
                        if (tblStoreListWithPaymentAddress.size() > 0) {
                            dbengine.saveSOAPdataStoreListAddressMap(tblStoreListWithPaymentAddress,Integer.parseInt(finalCoverageNodeId),Integer.parseInt(finalCoverageNodeType));
                        } else {
...
*/
                    ...
                    if (allMasterTablesModel.getTblForPDAGetPDAStoreSummary() != null) {
                        if (allMasterTablesModel.getTblForPDAGetPDAStoreSummary().size() > 0) {
                            dbengine.fnsavetblPDASummary(allMasterTablesModel.getTblForPDAGetPDAStoreSummary(),Integer.parseInt(finalCoverageNodeId),Integer.parseInt(finalCoverageNodeType));
                        } else {
                    ...
                    if (allMasterTablesModel.getTblStoreSummaryDetails() != null) {
                        if (allMasterTablesModel.getTblStoreSummaryDetails().size() > 0) {
                            dbengine.fnsavetblStoreSummaryDetails(allMasterTablesModel.getTblStoreSummaryDetails(),Integer.parseInt(finalCoverageNodeId),Integer.parseInt(finalCoverageNodeType));
                        } else {
                            blankTablearrayList.add("tblStoreSummaryDetails");
                        }
                    }

                    if (allMasterTablesModel.getTblStoreTarsSummaryDetails() != null) {
                        if (allMasterTablesModel.getTblStoreTarsSummaryDetails().size() > 0) {
                            dbengine.fnsavetblStoreTarsSummaryDetails(allMasterTablesModel.getTblStoreTarsSummaryDetails(),Integer.parseInt(finalCoverageNodeId),Integer.parseInt(finalCoverageNodeType));
                        } else {
                            blankTablearrayList.add("TblStoreTarsSummaryDetails");
                        }
                    }
                    ...
                    if (allMasterTablesModel.getTblForPDAStoreVisitHistory() != null) {
                        if (allMasterTablesModel.getTblForPDAStoreVisitHistory().size() > 0) {
                            dbengine.fnSaveTblPDAStoreVisitHistory(allMasterTablesModel.getTblForPDAStoreVisitHistory(),Integer.parseInt(finalCoverageNodeId),Integer.parseInt(finalCoverageNodeType));
                        } else {
                    ...
                    if (allMasterTablesModel.getTblForPDAStoreOrderHistory() != null) {
                        if (allMasterTablesModel.getTblForPDAStoreOrderHistory().size() > 0) {
                            dbengine.fnSaveTblPDAStoreOrderHistory(allMasterTablesModel.getTblForPDAStoreOrderHistory(),Integer.parseInt(finalCoverageNodeId),Integer.parseInt(finalCoverageNodeType));
                        } else {
                    ...
                    if (allMasterTablesModel.getTblStoreTARSSummary() != null) {
                        if (allMasterTablesModel.getTblStoreTARSSummary().size() > 0) {
                            dbengine.fnSaveTblStoreTARSSummary(allMasterTablesModel.getTblStoreTARSSummary(),Integer.parseInt(finalCoverageNodeId),Integer.parseInt(finalCoverageNodeType));
                        } else {
                    ...
                    if (allMasterTablesModel.getTblProductLevelData() != null) {
                        if (allMasterTablesModel.getTblProductLevelData().size() > 0) {
                            dbengine.fnSaveTblProductLevelData(allMasterTablesModel.getTblProductLevelData(),Integer.parseInt(finalCoverageNodeId),Integer.parseInt(finalCoverageNodeType));
                        } else {
                    ...
                    if (allMasterTablesModel.getTblAppliedOrderDiscountList() != null) {
                        if (allMasterTablesModel.getTblAppliedOrderDiscountList().size() > 0) {
                            dbengine.fnSaveTblAppliedOrderDiscount(allMasterTablesModel.getTblAppliedOrderDiscountList(),Integer.parseInt(finalCoverageNodeId),Integer.parseInt(finalCoverageNodeType));
                        } else {
                    ...
                    dbengine.fnDeleteTCOrderTable(Integer.parseInt(finalCoverageNodeId),Integer.parseInt(finalCoverageNodeType));
                    if (allMasterTablesModel.getTblInvoiceHeader() != null) {
                        if (allMasterTablesModel.getTblInvoiceHeader().size() > 0) {
                            for (TblInvoiceHeaderServer tblInvoiceHeaderServer : allMasterTablesModel.getTblInvoiceHeader()) {
                                ...
                                String StoreVisitCode = "StoreVisit" + "-" + tblInvoiceHeaderServer.getStoreID() + "-" + AppUtils.getToken(context) + "-" + OrdID;
                                ...
                                if (!hmapOrderIDPDAStoreIDs.containsKey(OrderIDPDA)) {
                                    dbengine.saveStoreTempInvoiceTCOrder(tblInvoiceHeaderServer.getStoreVisitCode(), tblInvoiceHeaderServer.getTmpInvoiceCodePDA(), tblInvoiceHeaderServer.getStoreID(), tblInvoiceHeaderServer.getInvoiceDate(), tblInvoiceHeaderServer.getTotalBeforeTaxDis(), tblInvoiceHeaderServer.getTaxAmt(), tblInvoiceHeaderServer.getTotalDis(), tblInvoiceHeaderServer.getInvoiceVal(), tblInvoiceHeaderServer.getFreeTotal(), tblInvoiceHeaderServer.getInvAfterDis(), tblInvoiceHeaderServer.getAddDis(), tblInvoiceHeaderServer.getNoCoupon(), tblInvoiceHeaderServer.getTotalCoupunAmount(), tblInvoiceHeaderServer.getTransDate(), Integer.parseInt(tblInvoiceHeaderServer.getFlgInvoiceType()), tblInvoiceHeaderServer.getFlgWholeSellApplicable(), 1, 1, 0, tblInvoiceHeaderServer.getRouteNodeID(), tblInvoiceHeaderServer.getRouteNodeType(), TeleCallingID,Integer.parseInt(finalCoverageNodeId),Integer.parseInt(finalCoverageNodeType));
                                }
                            }
                        } else {
                  ...
                  //  if(beatPlans!=null && beatPlans.size()>0)
                    ...
                    dbengine.deleteSubordinateList();
                    List<TblSubordinateList> tblSubordinateLists=  allMasterTablesModel.getTblSubordinateList();
                    if(tblSubordinateLists.size()>0){
                        dbengine.insertSubordinateList(tblSubordinateLists);
                    }


                    dbengine.delete_tblPersonGateMeetingTargetMstr();
                    List<TblPersonGateMeetingTarget> tblPersonGateMeetingTargetList=  allMasterTablesModel.getTblPersonGateMeetingTargetList();
                    if(tblPersonGateMeetingTargetList.size()>0){
                        dbengine.insert_tblPersonGateMeetingTargetMstr(tblPersonGateMeetingTargetList);
                    }

                    dbengine.delete_tblPersonGateMeetingFocusedProductCoverageWiseMstr();
                    List<TblPersonGateMeetingFocusedProductCoverageWiseMstr> tblPersonGateMeetingFocusedProductCoverageWiseMstrList=  allMasterTablesModel.getTblPersonGateMeetingFocusedProductCoverageWiseMstrList();
                    if(tblPersonGateMeetingFocusedProductCoverageWiseMstrList!=null && tblPersonGateMeetingFocusedProductCoverageWiseMstrList.size()>0){
                        dbengine.insert_tblPersonGateMeetingFocusedProductCoverageWiseMstr(tblPersonGateMeetingFocusedProductCoverageWiseMstrList);
                    }

                    HashMap<String, Integer> hmapDistributorRetailerStatus = new HashMap<String, Integer>();
                    hmapDistributorRetailerStatus = dbengine.fetchHmapDistributorRetailerSstat();
                    dbengine.delete_tblDistRetAddressDetail();
                    List<TblPotentialDistributorRetailersFeedBackDetails> tblPotentialDistributorRetailersFeedBackDetailsStoreSelection=  allMasterTablesModel.getTblDistRetAddressDetailList();
                    if(tblPotentialDistributorRetailersFeedBackDetailsStoreSelection!=null && tblPotentialDistributorRetailersFeedBackDetailsStoreSelection.size()>0){
                        dbengine.insert_tblDistRetAddressDetail(tblPotentialDistributorRetailersFeedBackDetailsStoreSelection,hmapDistributorRetailerStatus);
                    }
...
*/
    ...
    public static void getAllSummaryReportData(Context context, final String imei, String RegistrationID, String msgToShow) {
        ...
        SharedPreferences sharedPref = context.getSharedPreferences(CommonInfo.Preference, MODE_PRIVATE);
        int flgDataScope=0;
        if(sharedPref!=null && sharedPref.contains("flgDataScope"))
            flgDataScope=sharedPref.getInt("flgDataScope",0);
       ...
       */
        ...
        {
            PersonNodeId =sharedPref.getInt("SalesmanNodeId",0);
            PersonNodeType = sharedPref.getInt("SalesmanNodeType",0);
        }
       ...
       /* int PersonNodeId = 0;
        ...
        reportsInfo.setFlgDataScope(flgDataScope);
...
//   savetblDistributorDayReport(ProductNodeID, ProductNodeType, SKUName, FlvShortName,StockDate,CustomerNodeID,CustomerNodeType);
    ...
    public static void getStoreListData(final Activity context, Fragment fragment, String RegistrationID, String msgToShow, TblRouteListMaster tblRouteListMaster, Boolean setMsgRefreshOrRetrieving){
        AppDataSource mDataSource = AppDataSource.getInstance(context);
        final ProgressDialog mProgressDialog = new ProgressDialog(context);
        mProgressDialog.setTitle(msgToShow);//context.getResources().getString(R.string.Loading));
        if(setMsgRefreshOrRetrieving==true)
        {
            mProgressDialog.setMessage(context.getResources().getString(R.string.txtRefreshingData));
        }
        else {
        ...
        apiService= ApiClient.getClient().create(ApiInterface.class);
        int CoverageNodeId= tblRouteListMaster.getCoverageAreaNodeID();
        int CoverageNodeType= tblRouteListMaster.getCoverageAreaNodeType();
        int FlgAllRoutesData=1;
        String  serverDateForSPref=	mDataSource.fnGetServerDate();
        Data data=new Data();
        data.setApplicationTypeId(CommonInfo.Application_TypeID);
        data.setIMEINo(AppUtils.getToken(context));
        data.setVersionId(BuildConfig.VERSION_CODE);
        data.setAppVersionNo(BuildConfig.VERSION_NAME);
        data.setRegistrationId(RegistrationID);
        data.setForDate(fDate);
        data.setFlgAllRouteData(1);
        ...
        System.out.println("0000 Before getStoreListData Request "+data.toString());
        Call<StoreListTableModel> call= apiService.Call_StoreListData(data);


        call.enqueue(new Callback<StoreListTableModel>() {
            @Override
            public void onResponse(Call<StoreListTableModel> call, Response<StoreListTableModel> response) {
                System.out.println("0000 getStoreListData Respnse data"+response.body().toString());
                if(response.code()==200){
                    StoreListTableModel storeListTableModel=response.body();

                    SaveStoreListDataAsync saveStoreListDataAsync=new SaveStoreListDataAsync(context,storeListTableModel,CoverageNodeId,CoverageNodeType,interfaceRetrofit,mProgressDialog);
                    AppUtils.executeAsyncTask(saveStoreListDataAsync);
                }
                else{
            ...
            @Override
            public void onFailure(Call<StoreListTableModel> call, Throwable t) {
                mProgressDialog.dismiss();
                interfaceRetrofit.failure();
            }
        });
    ...
    public static void getSubOrdinateListData(final Activity context,Fragment fragment, String RegistrationID, String msgToShow, final int flgCldFrm){
        AppDataSource mDataSource = AppDataSource.getInstance(context);
        ...
        mProgressDialog.setCancelable(false);
        mProgressDialog.show();
        final InterfaceRetrofit interfaceRetrofit = (InterfaceRetrofit) fragment;
        final ArrayList blankTablearrayList=new ArrayList();
        Date date1 = new Date();
        SimpleDateFormat sdf = new SimpleDateFormat("dd-MMM-yyyy", Locale.ENGLISH);
        final String fDate = sdf.format(date1).toString().trim();
        ...
        Call<SubOrdinateModel> call= apiService.Call_SubOrdinateListData(data);

        call.enqueue(new Callback<SubOrdinateModel>() {
            @Override
            public void onResponse(Call<SubOrdinateModel> call, Response<SubOrdinateModel> response) {
                if(response.code()==200){
                    SubOrdinateModel subOrdinateModel=response.body();
                    mDataSource.deleteSubordinateList();
                    List<TblSubordinateList> tblSubordinateLists=  subOrdinateModel.getTblSubordinateList();
                    if(tblSubordinateLists.size()>0){
                        mDataSource.insertSubordinateList(tblSubordinateLists);
                    }
                    mProgressDialog.dismiss();
                    interfaceRetrofit.success();
                }
            ...
            @Override
            public void onFailure(Call<SubOrdinateModel> call, Throwable t) {
                mProgressDialog.dismiss();
                interfaceRetrofit.failure();
            }
        });
    ...
    public static class DistributionReportDownload extends AsyncTask {

        int flgCldFrm,CoverageAreaNodeID,CoverageAreaNodeType;
        String YesterDate;
        String  PersonNodeID;
        ...
        public DistributionReportDownload(Activity context, ProgressDialog mProgressDialog, MultipleInterfaceRetrofit interfaceRetrofit,String YesterDate,String PersonNodeID,String PersonNodeType,int flgCldFrm,int CoverageAreaNodeID,int CoverageAreaNodeType) {
        ...
        protected Object doInBackground(Object[] objects) {
            ...
            try {
                ...
                TblDistributionReportParameterData reportsInfo = new TblDistributionReportParameterData();
                reportsInfo.setPDACode(AppUtils.getToken(context));
                ...
                reportsInfo.setCoverageAreaNodeID(CoverageAreaNodeID);
                reportsInfo.setCoverageAreaNodeType(CoverageAreaNodeType);
                ApiInterface apiService = ApiClient.getClient().create(ApiInterface.class);
                Call<TblAllDistributionReportReturnedTables> call = apiService.DistributionReportMTD(reportsInfo);
                call.enqueue(new Callback<TblAllDistributionReportReturnedTables>() {
                    @Override
                    public void onResponse(Call<TblAllDistributionReportReturnedTables> call, Response<TblAllDistributionReportReturnedTables> response) {
                        if (response.code() == 200) {
                            TblAllDistributionReportReturnedTables allSummaryReportDayModel = response.body();
                            System.out.println("DATAENSERTEDSP");
                            dbengine.delete_tblRptDistribution();
                            List<TblRptDistribution> tblRptDistributionList=  allSummaryReportDayModel.getTblRptDistribution();
                            if(tblRptDistributionList!=null && tblRptDistributionList.size()>0){

                                dbengine.insert_tblRptDistribution(tblRptDistributionList,CoverageAreaNodeID,CoverageAreaNodeType);
                            }

                            dbengine.delete_tblRptDistribution2x();
                            List<TblRptDistribution> tblRptDistributionList2x=  allSummaryReportDayModel.getTblRptDistribution2x();
                            if(tblRptDistributionList2x!=null && tblRptDistributionList2x.size()>0){

                                dbengine.insert_tblRptDistribution2x(tblRptDistributionList2x,CoverageAreaNodeID,CoverageAreaNodeType);
                            }


                            dbengine.delete_tblRptSalesVersionIndivisual();
                            List<TblRptSalesVersionIndivisual> tblRptSalesVersionIndivisualList=  allSummaryReportDayModel.getTblRptSalesVersionIndivisual();
                            if(tblRptSalesVersionIndivisualList!=null && tblRptSalesVersionIndivisualList.size()>0){

                                dbengine.insert_tblRptSalesVersionIndivisual(tblRptSalesVersionIndivisualList,CoverageAreaNodeID,CoverageAreaNodeType);
                            }

                            dbengine.delete_tblRptSecVol();
                            List<TblRptSecVol> tblRptSecVolList=  allSummaryReportDayModel.getTblRptSecVol();
                            if(tblRptSecVolList.size()>0){

                                dbengine.insert_tblRptSecVol(tblRptSecVolList,CoverageAreaNodeID,CoverageAreaNodeType);
                            }


                            dbengine.delete_tblRptPrimaryVol();
                            List<TblRptPrimaryVol> tblRptPrimaryVolList=  allSummaryReportDayModel.getTblRptPrimaryVol();
                            if(tblRptPrimaryVolList.size()>0){

                                dbengine.insert_tblRptPrimaryVol(tblRptPrimaryVolList,CoverageAreaNodeID,CoverageAreaNodeType);
                            }


                            dbengine.delete_tblRptManDays();
                            List<TblRptManDays> tblRptManDaysList=  allSummaryReportDayModel.getTblRptManDays();
                            if(tblRptManDaysList.size()>0){

                                dbengine.insert_tblRptManDays(tblRptManDaysList,CoverageAreaNodeID,CoverageAreaNodeType);
                            }


                            dbengine.delete_tblDayWorkSummary();
                            List<TblDayWorkSummary> tblDayWorkSummaries=  allSummaryReportDayModel.getTblDayWorkSummary();
                            if(tblDayWorkSummaries!=null && tblDayWorkSummaries.size()>0){

                                dbengine.insert_tblDayWorkSummary(tblDayWorkSummaries,CoverageAreaNodeID,CoverageAreaNodeType);
                            }


                            List<TblRptDistributionDate> tblRptDistributionDates=allSummaryReportDayModel.getTblRptDistributionDate();
                    ...
                    @Override
                    public void onFailure(Call<TblAllDistributionReportReturnedTables> call, Throwable t) {
                        System.out.println();
                        context.runOnUiThread(() -> {
                            mProgressDialog.dismiss();
                            interfaceRetrofit.failure(flgCldFrm);
    ...
    public static void getDistributionPersonDailyStockstatus(final Activity context, String msgToShow, final int flgCldFrm,String EntryDate,int CustomerNodeID,int CustomerNodeType,int flgReportLevel){
        ...
        apiService= ApiClient.getClient().create(ApiInterface.class);
        //Activity context,Fragment fragment, String RegistrationID, String msgToShow, final int flgCldFrm,String EntryDate,int CustomerNodeID,int CustomerNodeType
        DataParametersDistributionReportsPersonSKUWise data=new DataParametersDistributionReportsPersonSKUWise();
        data.setPDACode(AppUtils.getToken(context));
        data.setEntryDate(EntryDate);
        data.setFlgReportLevel(flgReportLevel);
        data.setCustomerNodeId(CustomerNodeID);
        data.setCustomerNodeType(CustomerNodeType);


        Call<TblAllDistributionPersonSKUReturnTableList> call= apiService.GetDailyReportDistributorStock(data);

        call.enqueue(new Callback<TblAllDistributionPersonSKUReturnTableList>() {
            @Override
            public void onResponse(Call<TblAllDistributionPersonSKUReturnTableList> call, Response<TblAllDistributionPersonSKUReturnTableList> response) {
                if(response.code()==200){
                    TblAllDistributionPersonSKUReturnTableList tblAllDistributionPersonSKUReturnTableList=response.body();

                    List<TblDistributorDailyStockDetailsReport> tblDistributorDailyStockDetailsReportList=  tblAllDistributionPersonSKUReturnTableList.getTblDistributorDailyStockDetailsReport();
                    if(tblDistributorDailyStockDetailsReportList!=null && tblDistributorDailyStockDetailsReportList.size()>0){
                       mDataSource.insert_tblDistributorDailyStockDetailsReport(tblDistributorDailyStockDetailsReportList);
                    }
                    mProgressDialog.dismiss();
                    interfaceRetrofit.success();
                }
            ...
            @Override
            public void onFailure(Call<TblAllDistributionPersonSKUReturnTableList> call, Throwable t) {
                mProgressDialog.dismiss();
                interfaceRetrofit.failure();
            }
        });
    ...
    public static void getDistributionPersonDailyStockSKUList(final Activity context, String msgToShow, final int flgCldFrm,String EntryDate,int CustomerNodeID,int CustomerNodeType,int flgReportLevel,final String PersonName,final String DistributorName){
        ...
        mProgressDialog.setCancelable(false);
        mProgressDialog.show();
        final InterfaceRetrofitDistributorPersonStockDetails interfaceRetrofit = (InterfaceRetrofitDistributorPersonStockDetails) context;
        final ArrayList blankTablearrayList=new ArrayList();
        ...
        DataParametersDistributionReportsPersonSKUWise data=new DataParametersDistributionReportsPersonSKUWise();
        data.setPDACode(AppUtils.getToken(context));
      /*  if(EntryDate.equals("NA")) {
            Date date1 = new Date();
            SimpleDateFormat sdf = new SimpleDateFormat("dd-MMM-yyyy", Locale.ENGLISH);
            final String fDate = sdf.format(date1).toString().trim();
            data.setEntryDate(fDate);
        }
        else
            data.setEntryDate(EntryDate);*/
        Date date1 = new Date();
        ...
        call.enqueue(new Callback<TblAllDistributionPersonSKUReturnTableList>() {
            ...
            public void onResponse(Call<TblAllDistributionPersonSKUReturnTableList> call, Response<TblAllDistributionPersonSKUReturnTableList> response) {
                if(response.code()==200){
                    TblAllDistributionPersonSKUReturnTableList tblAllDistributionPersonSKUReturnTableList=response.body();
                    mDataSource.delete_tblDistributorDailyStockDetailsSKUReport();
                    List<TblDistributorDailyStockDetailsSKUReport> tblDistributorDailyStockDetailsSKUReportList=  tblAllDistributionPersonSKUReturnTableList.getTblDistributorDailyStockDetailsSKUReport();
                    if(tblDistributorDailyStockDetailsSKUReportList!=null && tblDistributorDailyStockDetailsSKUReportList.size()>0){
                        mDataSource.insert_tblDistributorDailyStockDetailsSKUReport(tblDistributorDailyStockDetailsSKUReportList);
                    }
                    mProgressDialog.dismiss();
                    interfaceRetrofit.successPersonStockDetails(PersonName,DistributorName);
                }
                else{
                    mProgressDialog.dismiss();
                    interfaceRetrofit.failurePersonStockDetails();
                }
    ...
    public static class GetSalesSummaryStoreWiseReportDetailDownload extends AsyncTask {
        ...
        public GetSalesSummaryStoreWiseReportDetailDownload(Activity context, ProgressDialog mProgressDialog, MultipleInterfaceRetrofit interfaceRetrofit,int ValueType,int PeriodType,int PersonNodeID,int PersonNodeType,int flgCldFrm,int SectionId,int CoverageAreaNodeID,int CoverageAreaNodeType) {
            this.context = context;
            this.mProgressDialog = mProgressDialog;
            this.interfaceRetrofit = interfaceRetrofit;
            this.flgCldFrm = flgCldFrm;
        ...
        protected Object doInBackground(Object[] objects) {
            ...
            try {
                ...
                TblSalesReportStoreListParameterData reportsInfo = new TblSalesReportStoreListParameterData();
                reportsInfo.setPDACode(AppUtils.getToken(context));
                reportsInfo.setRptDate( TimeUtils.getNetworkDate(context,TimeUtils.DATE_FORMAT));
                reportsInfo.setValueType(ValueType);
                reportsInfo.setPeriodType(PeriodType);
                reportsInfo.setPersonNodeID(PersonNodeID);
                reportsInfo.setPersonNodeType(PersonNodeType);
                reportsInfo.setSectionID(SectionId);
                reportsInfo.setCoverageAreaNodeID(CoverageAreaNodeID);
                reportsInfo.setCoverageAreaNodeType(CoverageAreaNodeType);

                ApiInterface apiService = ApiClient.getClient().create(ApiInterface.class);
                Call<TblAllSalesDistributionFleetReturnedTables> call = apiService.GetPDAGetSummaryReportDetail(reportsInfo);
                call.enqueue(new Callback<TblAllSalesDistributionFleetReturnedTables>() {
                    @Override
                    public void onResponse(Call<TblAllSalesDistributionFleetReturnedTables> call, Response<TblAllSalesDistributionFleetReturnedTables> response) {
                        if (response.code() == 200) {
                            TblAllSalesDistributionFleetReturnedTables allSummaryReportDayModel = response.body();
                            System.out.println("DATAENSERTEDSP");
                            dbengine.delete_tblSummaryReportDetails();
                            List<TblSummaryReportDetails> tblSummaryReportDetailsList=  allSummaryReportDayModel.getTblSummaryReportDetailsList();
                            if(tblSummaryReportDetailsList!=null && tblSummaryReportDetailsList.size()>0){

                                dbengine.insert_tblSummaryReportDetails(tblSummaryReportDetailsList);
                            }
                    ...
                    @Override
                    public void onFailure(Call<TblAllSalesDistributionFleetReturnedTables> call, Throwable t) {
                        System.out.println();
                        context.runOnUiThread(() -> {
                            mProgressDialog.dismiss();
                            interfaceRetrofit.failure(flgCldFrm);
